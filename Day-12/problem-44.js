...
// solution 2
function updateInventory_1(arr1, arr2) {
  // Concatenate the arrays and sort them by item name
  const concatenatedArray = arr1.concat(arr2);
  const updatedInventory = concatenatedArray.sort((a, b) =>
...
const updatedInventory_1 = updateInventory_1(curInv_2, newInv_2);
console.log(updatedInventory_1);
